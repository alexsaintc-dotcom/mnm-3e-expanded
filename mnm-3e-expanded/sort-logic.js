alert("M&M 3E EXPANDED SCRIPT STARTING");
console.error("M&M 3E EXPANDED | SCRIPT INITIALIZING (LOUD ERROR)");
console.warn("M&M 3E EXPANDED | SCRIPT INITIALIZING (LOUD WARN)");
console.log("M&M 3E EXPANDED | SCRIPT INITIALIZING (LOUD LOG)");

Hooks.once('init', () => {
  console.log("M&M 3E EXPANDED | INIT HOOK FIRED");
});

Hooks.once('ready', () => {
  console.log("M&M 3E EXPANDED | READY HOOK FIRED");
});
...
Hooks.on('renderActorSheet', (app, html, data) => {
  ...
  console.log("M&M 3E EXPANDED | RENDER ACTOR SHEET HOOK FIRED FOR: " + actor.name);
